...
const catalog = [
  ...
  { id: 'google_workspace', name: 'Google Workspace', mode: 'oauth', ready: false, capabilities: ['baseline', 'followup'] },
  { id: 'microsoft_365', name: 'Microsoft 365 / Teams', mode: 'oauth', ready: false, capabilities: ['baseline', 'attendance'] },
